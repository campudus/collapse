...
var Collapse = _react2["default"].createClass({
  ...
  propTypes: {
    ...
    customAnimClass: _react.PropTypes.string,
  ...
  getInitialState: function getInitialState() {
    ...
    var customAnimClass = _props.customAnimClass;
    ...
    return {
      openAnimation: this.props.openAnimation || (0, _openAnimationFactory2["default"])(prefixCls, customAnimClass),
  ...
  getItems: function getItems() {
    ...
    var customInActiveClass = _props2.customInActiveClass;
    var customHeaderClass = _props2.customHeaderClass;
    var customContentWrapperClass = _props2.customContentWrapperClass;

    return _react.Children.map(this.props.children, function (child, index) {
      // If there is no key provide, use the panel order as default key
      var idx = child.key || String(index);
      var key = String(child.props.index) || idx;
      ...
      var props = {
        ...
        customInActiveClass: customInActiveClass,
        customHeaderClass: customHeaderClass,
        customContentWrapperClass: customContentWrapperClass,
  ...
  render: function render() {
    ...
    var className = (0, _classnames3["default"])((_classnames = {}, _defineProperty(_classnames, prefixCls, true), _defineProperty(_classnames, this.props.customClassName, this.props.customClassName), _classnames));
