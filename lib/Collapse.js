...
var Collapse = _react2["default"].createClass({
  ...
  render: function render() {
    ...
    var className = (0, _classnames3["default"])((_classnames = {}, _defineProperty(_classnames, prefixCls, true), _defineProperty(_classnames, this.props.customClassName, this.props.customClassName), _defineProperty(_classnames, this.props.customInActiveClass, this.props.customInActiveClass), _classnames));
