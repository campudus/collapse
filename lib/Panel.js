...
var CollapsePanel = _react2["default"].createClass({
  ...
  render: function render() {
    ...
    var itemCls = (0, _classnames2["default"])((_classNames = {}, _defineProperty(_classNames, prefixCls + '-item', true), _defineProperty(_classNames, '' + activeClassName, isActive), _defineProperty(_classNames, prefixCls + '-item-active', isActive), _defineProperty(_classNames, className, className), _classNames));
